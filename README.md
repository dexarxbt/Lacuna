...
Lacuna does not claim mainnet completion yet. Root `strk20.json` and the public evidence index remain empty until real transactions pass public RPC receipt validation.
